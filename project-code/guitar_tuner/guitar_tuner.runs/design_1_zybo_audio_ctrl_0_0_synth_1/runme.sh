...
HD_PWD='/home/user/Documents/temp/embedded-final-project/project-code/guitar_tuner/guitar_tuner.runs/design_1_zybo_audio_ctrl_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_zybo_audio_ctrl_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_zybo_audio_ctrl_0_0.tcl
