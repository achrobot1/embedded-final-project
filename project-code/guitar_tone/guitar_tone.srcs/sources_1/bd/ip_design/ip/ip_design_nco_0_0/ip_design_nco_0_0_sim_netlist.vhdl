...
-- Date        : Sat Dec 14 12:01:13 2019
-- Host        : ece36 running 64-bit Ubuntu 16.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/user/Documents/embedded-final-project/project-code/guitar_tone/guitar_tone.srcs/sources_1/bd/ip_design/ip/ip_design_nco_0_0/ip_design_nco_0_0_sim_netlist.vhdl
...
entity ip_design_nco_0_0_nco_AXILiteS_s_axi is
  port (
    ...
    q0_reg_1 : in STD_LOGIC_VECTOR ( 14 downto 0 );
...
architecture STRUCTURE of ip_design_nco_0_0_nco_AXILiteS_s_axi is
  ...
  attribute SOFT_HLUTNM of \int_step_size_V[0]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \int_step_size_V[10]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \int_step_size_V[11]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \int_step_size_V[12]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \int_step_size_V[13]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \int_step_size_V[14]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \int_step_size_V[15]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \int_step_size_V[1]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \int_step_size_V[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \int_step_size_V[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \int_step_size_V[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \int_step_size_V[5]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \int_step_size_V[6]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \int_step_size_V[7]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \int_step_size_V[8]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \int_step_size_V[9]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \rdata_data[13]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \rdata_data[14]_i_1\ : label is "soft_lutpair1";
...
begin
  ...
  s_axi_AXILiteS_RVALID <= \FSM_sequential_rstate_reg__0\;
...
q0_reg_1: unisim.vcomponents.RAMB36E1
    generic map(
      ...
      DOADO(6 downto 0) => \out\(14 downto 8),
...
nco_sine_lut_V_rom_U: entity work.ip_design_nco_0_0_nco_sine_lut_V_rom
     port map (
      ...
      \rdata_data_reg[0]\ => \rdata_data_reg[0]\,
...
architecture STRUCTURE of ip_design_nco_0_0_nco is
  ...
  signal nco_AXILiteS_s_axi_U_n_20 : STD_LOGIC;
  signal nco_AXILiteS_s_axi_U_n_21 : STD_LOGIC;
  signal nco_AXILiteS_s_axi_U_n_22 : STD_LOGIC;
...
nco_AXILiteS_s_axi_U: entity work.ip_design_nco_0_0_nco_AXILiteS_s_axi
     port map (
      O(3) => nco_AXILiteS_s_axi_U_n_7,
      O(2) => nco_AXILiteS_s_axi_U_n_8,
      O(1) => nco_AXILiteS_s_axi_U_n_9,
      O(0) => nco_AXILiteS_s_axi_U_n_10,
      ...
      q0_reg_0 => sine_lut_V_U_n_0,
      q0_reg_1(14 downto 0) => int_sine_sample_V(15 downto 1),
      reset => reset,
      ...
      \temp_V_reg[11]\(3) => nco_AXILiteS_s_axi_U_n_15,
      \temp_V_reg[11]\(2) => nco_AXILiteS_s_axi_U_n_16,
      \temp_V_reg[11]\(1) => nco_AXILiteS_s_axi_U_n_17,
      \temp_V_reg[11]\(0) => nco_AXILiteS_s_axi_U_n_18,
      \temp_V_reg[15]\(3) => nco_AXILiteS_s_axi_U_n_19,
      \temp_V_reg[15]\(2) => nco_AXILiteS_s_axi_U_n_20,
      \temp_V_reg[15]\(1) => nco_AXILiteS_s_axi_U_n_21,
      \temp_V_reg[15]\(0) => nco_AXILiteS_s_axi_U_n_22,
      \temp_V_reg[7]\(3) => nco_AXILiteS_s_axi_U_n_11,
      \temp_V_reg[7]\(2) => nco_AXILiteS_s_axi_U_n_12,
      \temp_V_reg[7]\(1) => nco_AXILiteS_s_axi_U_n_13,
      \temp_V_reg[7]\(0) => nco_AXILiteS_s_axi_U_n_14
    );
sine_lut_V_U: entity work.ip_design_nco_0_0_nco_sine_lut_V
     port map (
      ...
      \rdata_data_reg[0]\ => sine_lut_V_U_n_0,
...
entity ip_design_nco_0_0 is
  ...
  attribute x_core_info of ip_design_nco_0_0 : entity is "nco,Vivado 2018.2";
